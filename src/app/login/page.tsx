...
function LoginPage() {
  return (
    <main className="flex items-center justify-center bg-[url('/img/bg_login.jpg')] bg-center bg-cover h-full">
      <div className="">
        <div className="icon logo_login mx-auto mb-8" />
        <div className="icon img_joinus mx-auto mb-6"></div>
        <div className="icon tag_login_base pt-[3px] mb-10">
        ...
        <div className="mt-5 flex justify-between w-[280px] px-3">
          <label>
            ...
            />
            <span className="ml-2 text-white tracking-wider">記住帳密</span>
          </label>
        ...
        <div className="icon btn_login_base mt-6 flex items-center justify-center">
          <div className="btn-text">登入</div>
        </div>
        ...
        <div className="space-x-6 text-center my-8 -ml-4">
          ...
          <span className="border-r border-white h-12"></span>
          <a href="#" className="text-white link">
            在線客服
          </a>
        </div>
